...
if(isset($_POST["btnsubmit"])) {
   $path = 'images/';
   $file = $path. $_POST['first_name'].'.png';
   $text = $_POST['text'];
   echo '<center>'. $_POST['first_name']." your qr code is here</center>";
   ?>
<html>
   <body>
   <img src = 'images/<?php echo $_POST['first_name']?>.png'>
   </body>
</html>
...
<head>
   ...
   <title>Lotus Electrical,Horana,Sri Lanka</title>
</head>

<body>
   <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #00ff5573;">
   Lotus Electrical,Horana,Sri Lanka
   </nav>
      ...
      <div class="container d-flex justify-content-center">
         <form action="" method="post" style="width:50vw; min-width:300px;">
            ...
            <div class="col">
                  ...
                  <input type="text" class="form-control" name="text" placeholder="QR code text" required>
               </div>
            ...
            <div>
               ...
               <button type="submit" class="btn btn-success" name="btnsubmit">QR Code</button>
            </div>
         </form>
      </div>
   </div>
